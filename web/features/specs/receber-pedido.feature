...
Funcionalidade: Receber pedido de locação
    ...
    Cenario: Receber pedido
        ...
        Dado que meu perfil de anunciante é "joao_anunciante@rocklov.com" e "pwd123"
        ...
        Quando "maria@rocklov.com" e "pwd123" solicita a locação desse equipo
        Então devo ver a seguinte mensagem:
            """
            maria_locataria@rocklov.com deseja alugar o equipamento: Trompete em: DATA_ATUAL
            """
